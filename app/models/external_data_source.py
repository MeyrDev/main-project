"""
Модель внешнего источника данных.

Описывает источник, из которого поступают данные для CRM и ML-модуля:
финансовая отчетность, транзакционные данные, внешние реестры, API или файлы.
"""
import enum
