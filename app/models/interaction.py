"""
Модель взаимодействия с организацией.

Хранит историю звонков, встреч, писем, заметок и задач.
Позволяет учитывать поведенческую и коммуникационную историю клиента.
"""
import enum
