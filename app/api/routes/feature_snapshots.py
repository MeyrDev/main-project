"""
API для работы со снимками признаков риска.

Позволяет добавлять и просматривать финансово-операционные признаки
организации, которые затем используются ML-моделью для прогноза риска.
"""
